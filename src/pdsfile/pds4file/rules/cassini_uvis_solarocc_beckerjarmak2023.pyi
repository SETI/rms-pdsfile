"""Type stubs for ``pdsfile.pds4file.rules.cassini_uvis_solarocc_beckerjarmak2023`` (see the module docstring there).
...
class cassini_uvis_solarocc_beckerjarmak2023(Pds4File):
    ARCHIVE_DIRS: _Translator
    ARCHIVE_PATHS: _Translator
