...
#
# Usage:
#   pdsdata-sync-volset [--dry-run] [--delete] <old> <new> <volset>
#
...
#
# Example:
#   pdsdata-sync-volset --delete admin staging VGx_9xxx
# copies all files relevant to the volume set "VGx_9xxx" from the drive pdsdata-admin to 
# the drive pdsdata-staging, deleting any extraneous files in the destination directories.
#########################################################################################
