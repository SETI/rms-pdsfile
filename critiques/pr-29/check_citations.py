...
CITATIONS = [
    ('src/pdsfile/pdsfile.py', 178, 'class PdsFile(_AssociationsMixin,'),
    ...
    ('src/pdsfile/pdscache.py', 1266, 'if key in self.permanent_values:'),
    ('src/pdsfile/pdscache.py', 1267, 'self._restore_permanent_to_cache()'),
    ('src/pdsfile/pdscache.py', 1309, 'def get_multi'),
    ('src/pdsfile/pdscache.py', 1347, 'for key in nonlocal_keys:'),
    ('src/pdsfile/pdscache.py', 1267, 'self._restore_permanent_to_cache()'),
    ('src/pdsfile/pdscache.py', 1364, 'break'),
    ('src/pdsfile/pdscache.py', 1575, 'if self.lifetime:'),
    ('src/pdsfile/pdscache.py', 1620, 'if key in self.permanent_values:'),
    ('src/pdsfile/pdscache.py', 1621, 'del self.permanent_values[key]'),
    ('src/pdsfile/pdscache.py', 1626, 'return status1 or status2'),
    ('src/pdsfile/pdscache.py', 1678, '_ = self.mc.del_multi(keys)'),
    ('src/pdsfile/pdscache.py', 1685, '_del_local'),
    ('src/pdsfile/pdscache.py', 1696, 'def _delete_local'),
    ('src/pdsfile/pdscache.py', 1693, 'count = len(self) - prev_len'),
    ('src/pdsfile/pdscache.py', 1754, "self.wait_for_unblock('clear')"),
    ('src/pdsfile/pdscache.py', 1756, "max(self.mc.get('$CLEAR_COUNT'), self.clear_count)"),
    ('src/pdsfile/pdscache.py', 1757, 'self.mc.flush_all()'),
    ('src/pdsfile/pdscache.py', 1802, 'lost from memcache'),
    ('src/pdsfile/pdscache.py', 1803, "self.mc.set('$CLEAR_COUNT', clear_count, time=0)"),
    ...
    ('src/pdsfile/pdscache.py', 1268, 'return self.permanent_values[key]'),
    ('src/pdsfile/pdscache.py', 1273, '(value, lifetime) = pair'),
    ('src/pdsfile/pdscache.py', 1425, '(value, _lifetime) = result'),
    ('src/pdsfile/pdscache.py', 1470, 'self.flush()'),
    ('src/pdsfile/pdscache.py', 1578, '0.999'),
    ...
    ('src/pdsfile/pdsviewable.py', 348, 'for sub_viewable in viewable.viewables:'),
    ('src/pdsfile/pdsviewable.py', 350, 'return'),
    ('src/pdsfile/pdsviewable.py', 352, 'self.viewables.add(viewable)'),
    ('src/pdsfile/pdsviewable.py', 355, 'if viewable.name:'),
    ('src/pdsfile/pdsviewable.py', 473, 'viewable.for_frame(200,200)'),
    ('src/pdsfile/pdsviewable.py', 490, 'viewable.for_frame(400,400)'),
    ('src/pdsfile/pdsviewable.py', 683, 'full_viewable = viewable'),
    ('src/pdsfile/pdsviewable.py', 685, 'viewables.append(viewable)'),
    ('src/pdsfile/pdsviewable.py', 848, "rpartition('/png-')"),
    ('src/pdsfile/pdsviewable.py', 850, "rpartition('/jpg-')"),
    ('src/pdsfile/pdsviewable.py', 866, "not in ('.png', 'jpg')"),
    ('src/pdsfile/pdsviewable.py', 874, 'except Image.UnidentifiedImageError:'),
    ('src/pdsfile/pdsviewable.py', 877, 'continue'),
    ('src/pdsfile/pdsviewable.py', 879, '(width, height) = im.size'),
    ('src/pdsfile/pdsviewable.py', 901, "key_base.replace('document_', '')"),
    ('src/pdsfile/pdsviewable.py', 902, "icon_name.replace('folder_', '')"),
    ('src/pdsfile/pdsviewable.py', 919, 'ICON_SET_BY_TYPE[icon_name, is_open] = viewset'),
    ('src/pdsfile/pdsviewable.py', 924, 'if (icon_name, True) not in ICON_SET_BY_TYPE:'),
    ('src/pdsfile/pdsviewable.py', 997, 'return ICON_SET_BY_TYPE[icon_type, is_open]'),
    ('src/pdsfile/pdsfile.py', 322, 'DICTIONARY_CACHE_LIMIT = 200000'),
    ('src/pdsfile/pdsfile.py', 497, 'self.permanent    = False'),
    ('src/pdsfile/pdsfile.py', 733, 'this.disk_        = None'),
    ('src/pdsfile/pdsfile.py', 758, 'this.permanent    = True'),
    ('src/pdsfile/pdsfile.py', 1126, "return ''"),
    ('src/pdsfile/pdsfile.py', 1135, "return ''"),
    ('src/pdsfile/pdsfile.py', 1179, 'return None'),
    ('src/pdsfile/pdsfile.py', 1297, "if '/' in self.logical_path:"),
    ('src/pdsfile/pdsfile.py', 1340, 'self.permanent = True'),
    ('src/pdsfile/pdsfile.py', 1590, "raise ValueError('Cannot define child from PDS root: '"),
    ('src/pdsfile/pdsfile.py', 1629, 'if logical_path in cls.CATEGORIES'),
    ('src/pdsfile/pdsfile.py', 1630, 'return cls.from_logical_path(logical_path,'),
    ('src/pdsfile/pdsfile.py', 1634, 'return cls.from_abspath(abspath,'),
    ('src/pdsfile/pdsfile.py', 1743, 'if ancestor and ancestor.abspath:'),
    ('src/pdsfile/pdsfile.py', 1920, 'if len(parts) == 0:'),
    ('src/pdsfile/pdsfile.py', 1941, 'def _from_absolute_or_logical_path'),
    ('src/pdsfile/pdsfile.py', 1967, 'fix_case=False, must_exist=False,'),
    ('src/pdsfile/pdsfile.py', 1971, 'fix_case=False, must_exist=False,'),
    ('src/pdsfile/pdsfile.py', 2132, 'part = parts[0].lower()'),
    ('src/pdsfile/pdsfile.py', 2160, 'parts = parts[:-1]'),
    ('src/pdsfile/pdsfile.py', 2262, "['$RANKS-' + this.category_][bundlename][-1]"),
    ('src/pdsfile/pdsfile.py', 2267, "idx = bundlename.index('_') + 1"),
    ('src/pdsfile/pdsfile.py', 2296, 'this_abspath = cls.CACHE'),
    ('src/pdsfile/pdsfile.py', 2302, 'except KeyError:'),
    ('src/pdsfile/pdsfile.py', 2345, "['$RANKS-' + this.category_][bundleset][-1]"),
