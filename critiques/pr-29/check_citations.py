...
CITATIONS = [
    ...
    ('src/pdsfile/_preload.py', 534, 'lifetime=cls.cache_lifetime'),
    ('src/pdsfile/_preload.py', 566, 'lifetime=cls.cache_lifetime'),
    ('src/pdsfile/_preload.py', 763, 'def cache_lifetime(cls, arg):'),
    ...
    ('src/pdsfile/_preload.py', 666, 'pdsdir.permanent = True'),
    ('src/pdsfile/_preload.py', 91, 'DICTIONARY_CACHE_LIMIT = 200000'),
    ('src/pdsfile/_preload.py', 93, 'def cache_lifetime_for_class(arg, cls=None):'),
    ('src/pdsfile/_preload.py', 154, "get_now('$PRELOADING')"),
