...
CITATIONS = [
    ...
    ('src/pdsfile/_preload.py', 562, 'lifetime=cls.cache_lifetime'),
    ('src/pdsfile/_preload.py', 594, 'lifetime=cls.cache_lifetime'),
    ('src/pdsfile/_preload.py', 791, 'def cache_lifetime(cls, arg):'),
    ...
    ('src/pdsfile/_preload.py', 694, 'pdsdir.permanent = True'),
    ('src/pdsfile/_preload.py', 96, 'DICTIONARY_CACHE_LIMIT = 200000'),
    ('src/pdsfile/_preload.py', 98, 'def cache_lifetime_for_class(arg, cls=None):'),
    ('src/pdsfile/_preload.py', 159, "get_now('$PRELOADING')"),
