...
CITATIONS = [
    ('src/pdsfile/pdsfile.py', 184, 'class PdsFile(_AssociationsMixin,'),
    ...
    ('src/pdsfile/pdsfile.py', 330, 'DICTIONARY_CACHE_LIMIT = 200000'),
    ('src/pdsfile/pdsfile.py', 505, 'self.permanent    = False'),
    ('src/pdsfile/pdsfile.py', 741, 'this.disk_        = None'),
    ('src/pdsfile/pdsfile.py', 766, 'this.permanent    = True'),
    ('src/pdsfile/pdsfile.py', 1134, "return ''"),
    ('src/pdsfile/pdsfile.py', 1143, "return ''"),
    ('src/pdsfile/pdsfile.py', 1187, 'return None'),
    ('src/pdsfile/pdsfile.py', 1305, "if '/' in self.logical_path:"),
    ('src/pdsfile/pdsfile.py', 1348, 'self.permanent = True'),
    ('src/pdsfile/pdsfile.py', 1598, "raise ValueError('Cannot define child from PDS root: '"),
    ('src/pdsfile/pdsfile.py', 1637, 'if logical_path in cls.CATEGORIES'),
    ('src/pdsfile/pdsfile.py', 1638, 'return cls.from_logical_path(logical_path,'),
    ('src/pdsfile/pdsfile.py', 1642, 'return cls.from_abspath(abspath,'),
    ('src/pdsfile/pdsfile.py', 1751, 'if ancestor and ancestor.abspath:'),
    ('src/pdsfile/pdsfile.py', 1928, 'if len(parts) == 0:'),
    ('src/pdsfile/pdsfile.py', 1949, 'def _from_absolute_or_logical_path'),
    ('src/pdsfile/pdsfile.py', 1975, 'fix_case=False, must_exist=False,'),
    ('src/pdsfile/pdsfile.py', 1979, 'fix_case=False, must_exist=False,'),
    ('src/pdsfile/pdsfile.py', 2141, 'part = parts[0].lower()'),
    ('src/pdsfile/pdsfile.py', 2169, 'parts = parts[:-1]'),
    ('src/pdsfile/pdsfile.py', 2271, "['$RANKS-' + this.category_][bundlename][-1]"),
    ('src/pdsfile/pdsfile.py', 2276, "idx = bundlename.index('_') + 1"),
    ('src/pdsfile/pdsfile.py', 2305, 'this_abspath = cls.CACHE'),
    ('src/pdsfile/pdsfile.py', 2311, 'except KeyError:'),
    ('src/pdsfile/pdsfile.py', 2354, "['$RANKS-' + this.category_][bundleset][-1]"),
